...
/**
 * Agentic Q&A prompt (Phase 1). Unlike buildChatSystemPrompt, this carries only
 * STATIC context (identity, voice, the user's profile/targets) — day-state, the
 * sourced library, and available foods are fetched on demand via tools. So the
 * number rules say "use tool results", not "use numbers in this prompt".
 */
